...
@section('title') Create New Menu @stop
...
@section('content')
    ...
    <div class="box box-success">
        ...
        {!! Form::open(['route' => 'admin.menu.store', 'role' => 'form', 'method' => 'post']) !!}
        <div class="box-body">
            <div class="col-md-6">
                <div class="form-group {{{ $errors->has('title') ? 'has-error' : '' }}}">
                    <label>Title</label>
                    {!! Form::text('title', null, ['class' => 'form-control','id'=>'title','value'=>Input::old('title'), 'placeholder' => 'Enter Menu Title']) !!}
                    {!! $errors->first('title', '<label class="error_txt_size">:message</label>') !!}
                </div>
                <div class="form-group {{{ $errors->has('menu_type') ? 'has-error' : '' }}}">
                    <label>Menu Type</label>
                    {!! Form::select('menu_type', array('' => 'Select Menu Type','top_menu' => 'Top Menu', 'footer_menu' => 'Footer Menu'),null,array('class' => 'form-control', 'value'=>Input::old('menu_type'))) !!}
                ...
                <div class="form-group {{{ $errors->has('content_type') ? 'has-error' : '' }}}">
                    ...
                    <div class="input-group">
                        {!! Form::text('content_type', null, ['class' => 'form-control','id'=>'content_type','readonly','value'=>Input::old('content_type'), 'placeholder' => 'Select Content Type']) !!}
                ...
                <div class="form-group {{{ $errors->has('title') ? 'has-error' : '' }}}">
                    <label>Order</label>
                    {!! Form::text('order', null, ['class' => 'form-control','id'=>'order','value'=>Input::old('order'), 'placeholder' => 'Enter Order']) !!}
            ...
            <div class="col-md-6">
                <div class="form-group {{{ $errors->has('alias') ? 'has-error' : '' }}}">
                    ...
                    {!! Form::text('alias', null, ['class' => 'form-control','id'=>'alias','value'=>Input::old('alias'), 'placeholder' => 'Enter Title Alias']) !!}
                    {!! $errors->first('alias', '<label class="error_txt_size">:message</label>') !!}
                </div>
                <div class="form-group {{{ $errors->has('parent_id') ? 'has-error' : '' }}}">
                    <label>Parent Item </label>
                    {!! Form::select('parent_id', $menus, null, array('class' => 'form-control', 'value'=>Input::old('parent_id'))) !!}
                ...
                <div class="form-group {{{ $errors->has('link') ? 'has-error' : '' }}}">
                    <label>Link</label>
                    {!! Form::text('link', null, ['class' => 'form-control','readonly','id'=>'link','value'=>Input::old('link'), 'placeholder' => 'Enter Menu Link']) !!}
                    {!! $errors->first('link', '<label class="error_txt_size">:message</label>') !!}
                </div>
                <div class="form-group {{{ $errors->has('published') ? 'has-error' : '' }}}">
                    <label>Published Status</label>
                    {!! Form::select('published', array('1' => 'Published', '0' => 'Unpublished'),null,array('class' => 'form-control', 'value'=>Input::old('published'))) !!}
