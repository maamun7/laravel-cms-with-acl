...
@section ('breadcrumbs')
    ...
    <li class="active"> <a href="{!! route('admin.article.new') !!}"> Create Article </a> </li>
@stop
...
@section('content')
    ...
    <div class="box box-success">
        ...
        {!! Form::open(['route' => 'admin.article.store', 'role' => 'form', 'method' => 'post']) !!}
        <div class="box-body">
            <div class="col-md-12">
                <div class="form-group {{{ $errors->has('article_name') ? 'has-error' : '' }}}">
                    <label>Article Name</label>
                    {!! Form::text('article_name', null, ['class' => 'form-control','id'=>'fast_name','value'=>Input::old('article_name'), 'placeholder' => 'Enter article name']) !!}
                ...
                <div class="form-group {{{ $errors->has('article_category') ? 'has-error' : '' }}}">
                    ...
                    {!! Form::select('article_category', $categories, null, array('class' => 'form-control', 'value'=>Input::old('article_category'))) !!}
                    {!! $errors->first('article_category', '<label class="error_txt_size">:message</label>') !!}
                </div>
                <div class="form-group {{{ $errors->has('description') ? 'has-error' : '' }}}">
                    <label>Description</label>
                    {!! Form::textarea('description', null, ['class' => 'form-control ckeditor','size' => '30x5','value'=>Input::old('description'), 'placeholder' => 'Enter article details']) !!}
